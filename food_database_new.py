...
class Meal(Base):
    ...
    recipe_items = relationship("Recipe", cascade="save-update, merge, delete")
...
class Recipe(Base):
    ...
    ingredient = relationship("Ingredient", back_populates="referencedIn")
...
class Ingredient(Base):
    ...
    referencedIn = relationship("Recipe",
